...
2. Open a [GitHub Security Advisory](https://github.com/launchborn/codex-seo/security/advisories/new) on this repo
...
- Install scripts write only to user-level directories (`~/.codex/`)
