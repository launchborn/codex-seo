...
| optimize | codex-prompt-1.md | Codex Prompt 1 | Codex Prompt 1 |
| optimize | codex-prompt-2.md | Codex Prompt 2 | Codex Prompt 2 |
...
| optimize | reddit-codex-prompt.md | Reddit Codex Prompt | Reddit Codex Prompt |
...
| local | codex-deep-research-prompt.md | Codex Deep Research Prompt | Codex Deep Research Prompt |
| local | gbp-categories-prompt.md | GBP Categories Prompt | GBP Categories Prompt |
| local | gbp-description-codex-prompt-1.md | GBP Description Codex Prompt 1 | GBP Description Codex Prompt 1 |
| local | gbp-description-codex-prompt-2.md | GBP Description Codex Prompt 2 | GBP Description Codex Prompt 2 |
| local | gbp-description-codex-prompt-3.md | GBP Description Codex Prompt 3 | GBP Description Codex Prompt 3 |
