...
Codex SEO — це навичка Codex, яка працює повністю на вашому локальному комп'ютері. Основна навичка не збирає, не передає та не зберігає жодних персональних даних.

## Що залишається локально

- Весь SEO-аналіз виконується у вашій сесії Codex
...
- API-ключі та токени OAuth зберігаються локально в `~/.config/codex-seo/` або змінних оточення
